...
class QueryGenerator:
    """
    QueryGenerator class will contain different methods to generate search queries 
    based on key-terms, key-concepts, etc.

    Functions: 

    - __init__: Initialize the QueryGenerator class.
    - getter methods for terms, concepts, 
    """
    ...
    def get_terms(self, file_path: Path | str) -> tuple[pd.Series, set[str]]:
        """
    ...
    def get_keyterms_by_importance(self, keyterms: pd.Series, importance: any) -> pd.Series:
        """
    ...
    def get_sources(self, file_path: Path | str) -> pd.Series:
        """ 
    ...
    def create_thesaurus(self, keyterms: pd.Series) -> tuple[list[dict[str, str, set[str]]], set[str]]:
        """
